...
;; Ex 4.25 Will work in normal-order not applicative-order
(define (factorial n)
  (unless (= n 1)
	  (* n (factorial (- n 1)))
	  1))
...
;; Ex 4.26
;; Can't be bothered to do derived expression - it just turns into a simple if.
;; Can't think of a really good example of where it would be handy as a function
;; but you could do things like
(define (foo switcher pred val1 val2)
  (switcher pred val1 val2))
